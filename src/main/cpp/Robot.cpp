  ...
  void AutonomousInit() override
  {
    ...
    else if (path == "Barrel")
    {
      ...
      std::vector<frc::Spline<5>::ControlVector> points{
          ...
          {{4.621569477801414, -0.07247183146915503, 0.0},
           {-3.10624936526453, -0.9882522473066637, 0.0}},
          {{3.758495848486928, -0.7049532697454195, 0.0},
           {-3.8309676799560832, 0.032941741576888894, 0.0}},
          {{3.0008357922184867, 0.006588348315378578, 0.0},
           {-2.9876590955877314, 1.3044929664447955, 0.0}},
          ...
          {{7.467735950044604, -1.4757900226446186, 0.0},
           {-2.335412612365334, -0.01317669663075538, 0.0}},
          {{4.535920949701502, -1.5372125985868543, 0.0},
           {-2.361766005626844, 0.01795621902639254, 0.0}},
          {{2.8558921292801758, -1.2188309188848432, 0.0},
           {-2.3222359157345775, 0.024834645140939617, 0.0}},
          {{0.8793876346668497, -0.5204795169148426, 0.0},
           {-2.289294174157689, 0.013176696630756268, 0.0}}};
