...
public:
  ...
  void AutonomousInit() override
  {
    ...
    else if (path == "Barrel")
    {
      ...
      rj::DiffyDriveTrajectoryConstraint m_drivetrain_constraint{grasshopper, 0.125_psi};
      ...
      std::vector<frc::Spline<5>::ControlVector> points{
          ...
          {{3.7716725451176836, 1.0102204302553026, 0.0},
           {-2.309059219103822, -0.35157914818672376, 0.0}},
          {{4.39756563507857, 0.2419384523671363, 0.0},
           {-2.5857698483496883, -0.2947139590077909, 0.0}},
          {{4.575451039593769, -0.12517861799217656, 0.0},
           {-3.1194260618952856, -0.8762503259452408, 0.0}},
          ...
          {{6.92090303986825, 0.02635339326151165, 0.0},
           {-1.5382224662046253, 1.2451978316063956, 0.0}},
          {{6.051241062238384, -1.1002541686680827, 0.0},
           {-0.7542090166746724, -0.00658834831537769, 0.0}},
          {{5.214520826185412, 0.08564852809990953, 0.0},
           {-1.5316341178892476, -1.2913162698140397, 0.0}},
          ...
          {{8.284691141151445, -0.19550749596844225, 0.0},
           {-2.7307135112879988, 0.3708499485906332, 0.0}},
          {{7.579737871406025, -0.5731863034378639, 0.0},
           {-2.361766005626844, 0.013176696630754936, 0.0}},
          {{6.374070129691897, -1.5087269740275056, 0.0},
           {-2.3683543539422214, -0.00764308810313674, 0.0}},
          {{3.0535425787415083, -1.8973902140248113, 0.0},
           {-2.3815310505729768, -0.02465610015128953, 0.0}},
