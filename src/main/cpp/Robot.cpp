...
public:
  ...
  void AutonomousInit() override
  {
    ...
    else if (path == "Barrel")
    {
      ...
      rj::DiffyDriveTrajectoryConstraint m_drivetrain_constraint{grasshopper, 0.0875_psi}; //.125

      frc::TrajectoryConfig config(17.5_fps, 25_fps_sq); //17.5 15
      //config.AddConstraint(m_drivetrain_constraint);
      config.AddConstraint(frc::CentripetalAccelerationConstraint{14_fps_sq});

      config.SetEndVelocity(17.5_fps);

      std::vector<frc::Spline<5>::ControlVector> points{
          {{1.2022167021203596, 0.45459603376106505, 0.0},
           {-2.2497640842654225, 0.00658834831537769, 0.0}},
          {{4.410742331709326, 1.0409590338296848, 0.0},
           {-2.4935329719343993, -1.1463726068757292, 0.0}},
          {{3.9034395114252387, -1.5877919440060388, 0.0},
           {-3.9100278597406164, -0.01317669663075538, 0.0}},
          {{3.264369724833597, 1.409906539490838, 0.0},
           {-2.5462397584574212, 1.8776792698826597, 0.0}},
          {{6.275244904961231, 1.1002541686680836, 0.0},
           {-2.3222359157345775, 0.20423879777671017, 0.0}},
          {{6.723252590406917, -1.4757900226446177, 0.0},
           {-0.7805624099361834, 1.4033181911754615, 0.0}},
          {{5.069577163247103, 0.06588348315377601, 0.0},
           {-1.5711642077815142, -1.8776792698826594, 0.0}},
          {{7.606091264667536, 1.6009686406367942, 0.0},
           {-3.8902628147944833, 0.01976504494613307, 0.0}},
          {{8.56140177039731, -0.05270678652302152, 0.0},
           {-3.0667192753722645, 1.185902696767996, 0.0}},
          {{7.546796129829136, -1.449436629383106, 0.0},
           {-2.0059951965964458, 0.019765044946133514, 0.0}},
          {{4.680864612639814, -1.4911886360900293, 0.0},
           {-1.9730534550195569, 0.010074291176227743, 0.0}},
          {{3.0733076236876413, -1.3946452652967518, 0.0},
           {-1.9664651067041792, 0.017220333747804826, 0.0}},
          {{0.4972634323749401, -0.5204795169148426, 0.0},
           {-1.9005816235504016, 0.013176696630756268, 0.0}}};
