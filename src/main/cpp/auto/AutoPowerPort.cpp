...
void AutoPowerPort::Init()
{
    ...
    {    
        {
            {1.6197307137707282, 0.7874091564527756, 0.0}, //x
            {-2.216777217015141, 0.969118961788032, 0.0} //y
        },
        {
            {2.260041456380678, 0.01730569574621521, 0.0}, //x
            {-1.2303525594808942, 0.6749221341023793, 0.0} //y
        }
    };
