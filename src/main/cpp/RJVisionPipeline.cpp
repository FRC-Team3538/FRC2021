...
*/
void RJVisionPipeline::Process(cv::Mat& source0){
	//Step HSL_Threshold0:
	//input
 ...
 */
cv::Mat* RJVisionPipeline::GetHslThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* RJVisionPipeline::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* RJVisionPipeline::GetFilterContoursOutput(){
	...
	void RJVisionPipeline::hslThreshold(cv::Mat &input, double hue[], double sat[], double lum[], cv::Mat &out) {
	 ...
	 */
	void RJVisionPipeline::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
